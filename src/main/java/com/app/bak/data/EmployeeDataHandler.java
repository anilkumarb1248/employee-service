...
public class EmployeeDataHandler {
	...
	private static void loadData() {
		...
		EMPLOYEES_DATA_MAP.put(autoIncreamentEmpId, new Employee(autoIncreamentEmpId++, "Anil", "Kumar", "Bandari", Role.TA, 10000, getDOB("05/02/1990"), Gender.Male, 123456789, "anil@gmail.com", "YRP", 506366, MaritalStatus.Married));
		EMPLOYEES_DATA_MAP.put(autoIncreamentEmpId, new Employee(autoIncreamentEmpId++, "Manasvi", "", "Bandari", Role.LEAD, 20000, getDOB("08/15/1998"), Gender.Female, 123456789, "manu@gmail.com", "YRP", 506366, MaritalStatus.Married));
		EMPLOYEES_DATA_MAP.put(autoIncreamentEmpId, new Employee(autoIncreamentEmpId++, "Sahanvika", "Pinkulu", "Bandari", Role.CEO, 30000, getDOB("10/23/2020"), Gender.Female, 123456789, "pinky@gmail.com", "YRP", 506366, MaritalStatus.Unmarried));
		EMPLOYEES_DATA_MAP.put(autoIncreamentEmpId, new Employee(autoIncreamentEmpId++, "Jasmitha", "Jassy", "Bandari", Role.SE, 40000, getDOB("01/01/2007"), Gender.Female, 123456789, "jasmitha@gmail.com", "YRP", 506366, MaritalStatus.Unmarried));
		EMPLOYEES_DATA_MAP.put(autoIncreamentEmpId, new Employee(autoIncreamentEmpId++, "Jasvanth", "Jassy", "Bandari", Role.MANAGER, 50000, getDOB("04/24/2010"), Gender.Male, 123456789, "jasvanth@gmail.com", "YRP", 506366, MaritalStatus.Unmarried));
	}
